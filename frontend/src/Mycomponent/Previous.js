...
export default function Previous() {
  ...
  const sendOrderOTP = async () => {
    try {
      const response = await axios.post ("https://the-great-indian-restrauant.vercel.app/send-order-otp", {email});
  ...
  const fetchOrders = async () => {
    ...
    try {
      const response = await axios.get("https://the-great-indian-restrauant.vercel.app/api/orders", {
        params: { email },
      });
  ...
  const verifyOrderOTP = async () => {
    try {
      const response = await axios.post ("https://the-great-indian-restrauant.vercel.app/verify-order-otp", {email, otp});
      if (response.data.success) {
